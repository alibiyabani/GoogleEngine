...
namespace GoogleEngine.Controllers
{
    public class SearchesController : Controller
    {
        ...
        public SearchesController(GoogleEngineContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Link,Snippet,Term,SearchDate")] Search search)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Link,Snippet,Term,SearchDate")] Search search)
        {
            if (id != search.Id)
            {
                return NotFound();
